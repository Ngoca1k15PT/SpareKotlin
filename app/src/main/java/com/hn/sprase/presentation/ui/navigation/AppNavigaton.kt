...
import com.hn.sprase.presentation.screen.cards.CardsScreen
...
fun AppNavigation(){
    ...
    NavHost(navController, startDestination = Routers.cardsScreen, builder = {
        ...
        composable(Routers.cardsScreen ) {
            CardsScreen()
        }
    })
}